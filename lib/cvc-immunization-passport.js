...
var cvcFhirOcaConverter = {
    ...
    verifyCVCBundle: async(patientpassport) =>  {
      var jsonobject = fs.readFileSync('examples/cvc-immunization-passport/cvc-valuesets-fhir.json');
      ...
      console.log(`verifyCVCBundle: calling fhir.validate`);
    ...
    generateOCAFormatOverlay: function(immnzpassportdoc, context, schemabase_hashlink) {
      ...
      generateOCAArtifacts: async function(cfg, bundlepath,profile) {
        ...
        .then(async (hlcache) => {
          ...
          module.exports.verifyCVCBundle(bundleobject);
