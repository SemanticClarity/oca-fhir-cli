...
var handlebars = {
    ...
    getCharacterOverlay: Handlebars.registerHelper('getCharacterOverlay', function(resourcename) {
        let retval = nsHelper.trimNamespacePrefix(resourcename);
    ...
    getInformationOverlay: Handlebars.registerHelper('getInformationOverlay', function(resourcename) {
        let retval = nsHelper.trimNamespacePrefix(resourcename);
