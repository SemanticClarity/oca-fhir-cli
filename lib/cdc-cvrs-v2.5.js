...
var cdcFhirOcaConverter = {
    ...
    verifyFHIRBundle: async(patientpassport) =>  {
      var jsonobject = fs.readFileSync('examples/cdc-cvrs-v2.5/cvc-valuesets-fhir.json');
      ...
      console.log(`verifyBundle: calling fhir.validate`);
    ...
    generateOCAFormatOverlay: function(immnzpassportdoc, context, schemabase_hashlink) {
        const formathbs = fs.readFileSync('templates/cdc-cvrs-v2.5/cdc-cvrs-v2.5-formatoverlay.hbs', 'utf-8');
      ...
      generateOCAEntryOverlay: function (immnzpassportdoc, context, schemabase_hashlink) {
        const entryhbs = fs.readFileSync('templates/cdc-cvrs-v2.5/cdc-cvrs-v2.5-entryoverlay.hbs', 'utf-8');
      ...
      generateOCACharacterOverlay: function(immnzpassportdoc, context, schemabase_hashlink) {
        const formathbs = fs.readFileSync('templates/cdc-cvrs-v2.5/cdc-cvrs-v2.5-characteroverlay.hbs', 'utf-8');
        const compiled_template = Handlebars.compile(formathbs);
        var result = compiled_template(immnzpassportdoc,{
            "data": {
                "author": "FHIR OCA WG",
      ...
      generateOCAInformationOverlay: function(immnzpassportdoc, context, schemabase_hashlink) {
        const informationhbs = fs.readFileSync('templates/cdc-cvrs-v2.5/cdc-cvrs-v2.5-informationoverlay.hbs', 'utf-8');
      ...
      generateOCALabelOverlay: function(immnzpassportdoc, context, schemabase_hashlink) {
        const labelhbs = fs.readFileSync('templates/cdc-cvrs-v2.5/cdc-cvrs-v2.5-labeloverlay.hbs', 'utf-8');
      ...
      generateOCAArtifacts: async function(cfg, bundlepath,profile) {
